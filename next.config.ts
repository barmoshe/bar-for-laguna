...
// export under `/bar-for-laguna`. The mirror is a fallback, not the canonical
...
//   `${NEXT_PUBLIC_BASE_PATH ?? ''}` (see src/marketing/laguna/LagunaApp.tsx).
const isPages = process.env.GH_PAGES === "1";
const basePath = "/bar-for-laguna";
